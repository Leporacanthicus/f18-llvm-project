...
!CHECK: omp.reduction.declare @min_f_32 : !fir.ref<f32> init {
...
!CHECK-LABEL: omp.reduction.declare @min_i_32 : !fir.ref<i32> init {
...
!CHECK:   omp.parallel
!CHECK:     omp.wsloop reduction(@min_i_32 %[[X_REF]] -> %[[PRV:.+]] : !fir.ref<i32>) for
...
!CHECK:   omp.parallel
!CHECK:     omp.wsloop reduction(@min_f_32 %[[X_REF]] -> %[[PRV:.+]] : !fir.ref<f32>) for
