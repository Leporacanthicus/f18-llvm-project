...
!CHECK: omp.reduction.declare @max_f_32 : !fir.ref<f32> init {
...
!CHECK-LABEL: omp.reduction.declare @max_i_32 : !fir.ref<i32> init {
...
!CHECK:   omp.parallel
!CHECK:     omp.wsloop reduction(@max_i_32 %[[X_REF]] -> %[[PRV:.+]] : !fir.ref<i32>) for
...
!CHECK:   omp.parallel
!CHECK:     omp.wsloop reduction(@max_f_32 %[[X_REF]] -> %[[PRV:.+]] : !fir.ref<f32>) for
