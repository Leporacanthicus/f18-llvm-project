...
! FIRDialect:             fir.store %[[VAL_9]] to %[[STORE_1:.*]] : !fir.ref<i32>
! FIRDialect:             fir.store %[[VAL_10]] to %[[STORE_2:.*]] : !fir.ref<i32>
! FIRDialect:             fir.store %[[VAL_11]] to %[[STORE_3:.*]] : !fir.ref<i32>
! FIRDialect:             %[[VAL_12:.*]] = fir.load %[[VAL_6]] : !fir.ref<i32>
! FIRDialect:             %[[LOAD_1:.*]] = fir.load %[[STORE_1]] : !fir.ref<i32>
! FIRDialect:             %[[VAL_13:.*]] = arith.addi %[[VAL_12]], %[[LOAD_1]] : i32
! FIRDialect:             %[[LOAD_2:.*]] = fir.load %[[STORE_2]] : !fir.ref<i32>
! FIRDialect:             %[[VAL_14:.*]] = arith.addi %[[VAL_13]], %[[LOAD_2]] : i32
! FIRDialect:             %[[LOAD_3:.*]] = fir.load %[[STORE_3]] : !fir.ref<i32>
